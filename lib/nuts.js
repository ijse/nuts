...
function Nuts(opts) {
    ...
    this.router.get('/download/latest-mac.json', this.onMacCheck);
...
Nuts.prototype.onMacCheck = function(req, res, next) {
    var that = this;
    this.versions.resolve()
        .then(function(version) {
            var asset = _.find(version.platforms, {
                filename: 'latest-mac.json'
            })
